...
pdf_path = 'pdf-sessoes/sessao-4.pdf'
output_dir = 'modulo-1/img/sessao-3'
...
for page_num, text in enumerate(pages_text):
    ...
    if any(ip[0] == page_num for ip in images_info):
        ...
        # The image path relative to the HTML file: from modulo-1/sessao-3.html, we go to img/sessao-3/
        img_src = f'img/sessao-3/p{page_num+1}-vector.png'
...
title_pt = "Sessão 3: A Importância do Templo"
title_en = "Session 3: The Importance of the Temple"
...
template = template.replace('ezekiel-s1-lang', 'ezekiel-s3-lang')
...
output_path = 'modulo-1/sessao-3.html'
with open(output_path, 'w') as f:
    f.write(new_template)

print(f'Session 3 written to {output_path}')
