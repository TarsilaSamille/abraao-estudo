...
pdf_path = 'pdf-sessoes/sessao-7.pdf'
output_dir = 'modulo-1/img/sessao-6'
...
for page_num, text in enumerate(pages_text):
    ...
    if any(ip[0] == page_num for ip in images_info):
        ...
        # The image path relative to the HTML file: from modulo-1/sessao-6.html, we go to img/sessao-6/
        img_src = f'img/sessao-6/p{page_num+1}-vector.png'
...
title_pt = "Sessão 6: O Coração de Deus para Seu Povo"
title_en = "Session 6: God's Heart for His People"
...
template = template.replace('ezekiel-s2-lang', 'ezekiel-s6-lang')
...
output_path = 'modulo-1/sessao-6.html'
with open(output_path, 'w') as f:
    f.write(new_template)

print(f'Session 6 written to {output_path}')