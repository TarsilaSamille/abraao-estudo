    ...
    (async () => {
      ...
      await page.goto('file:///Users/macbook/GitHub/biblia-estudo/heaven-and-earth/modulo-1/sessao-1.html', { waitUntil: 'networkidle' });
      ...
      await page.pdf({ path: '/Users/macbook/GitHub/biblia-estudo/heaven-and-earth/verify/html-s1.pdf', printBackground: true, format: 'A4', preferCSSPageSize: false });
      await browser.close();
    })();
