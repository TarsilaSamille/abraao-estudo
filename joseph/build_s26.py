...
template = template.replace("localStorage.setItem('joseph-s26-lang',l)", "localStorage.setItem('joseph-s14-lang',l)")
template = template.replace("localStorage.getItem('joseph-s26-lang')", "localStorage.getItem('joseph-s14-lang')")
