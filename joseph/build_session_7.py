...
# Get title: we know the second line (index 2) of the first page is "Session 7: Down Into the Pit"
first_page_lines = pages_text[0].split('\\n')
if len(first_page_lines) > 2 and first_page_lines[2].strip().startswith("Session"):
    title_line = first_page_lines[2].strip()
else:
    # fallback: find the line that starts with "Session"
    title_line = ""
