...
div_close_start = search_start + close_match.start()
div_close_end = search_start + close_match.end()
...
# We'll keep the content before HR, and the closing div + script
page_content = ""
...
new_template = template[:content_before_hr_end] + page_content + template[div_close_start:div_close_end] + template[div_close_end:]
