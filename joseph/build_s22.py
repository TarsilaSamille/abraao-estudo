...
template = template.replace("localStorage.setItem('joseph-s22-lang',l)", "localStorage.setItem('joseph-s21-lang',l)")
template = template.replace("localStorage.getItem('joseph-s22-lang')", "localStorage.getItem('joseph-s21-lang')")
