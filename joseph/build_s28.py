...
base = os.getcwd()
N = 28
pdf_path = f"{base}/pdf-sessoes/sessao-{N+1}.pdf"  # sessao-29.pdf
...
template = template.replace("localStorage.setItem('joseph-s2-lang',l)", "localStorage.setItem('joseph-s28-lang',l)")
template = template.replace("localStorage.getItem('joseph-s2-lang')", "localStorage.getItem('joseph-s28-lang')")
