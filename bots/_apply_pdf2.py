#!/usr/bin/env python3
# Cores EXATAS do sessao-2.pdf pagina 3 (pdftocairo 300dpi) - a pagina do design colorido.
# red #ba4866 | green #367e60 | blue #3678b4 | grey #a2a2ae
P="abraao/modulo-1/sessao-2.html"
h=open(P,encoding='utf-8').read()
R,G,B,K="#ba4866","#367e60","#3678b4","#a2a2ae"
OLD=["#a85a43","#3c6049","#34588b","#787878","#ae5266","#4c7c60","#4876ae","#9c9ca4",
     "#af5267","#487860","#4877ae","#9d9ea7","#b44860","#307860","#3078b4","#9c9ca8"]
M={"#a85a43":R,"#3c6049":G,"#34588b":B,"#787878":K,"#ae5266":R,"#4c7c60":G,"#4876ae":B,
   "#9c9ca4":K,"#af5267":R,"#487860":G,"#4877ae":B,"#9d9ea7":K,"#b44860":R,"#307860":G,
   "#3078b4":B,"#9c9ca8":K}
for old in OLD:
    for pre in ("border-[","bg-[","text-["):
        h=h.replace(pre+old+"]",pre+M[old]+"]")
...
h=h.replace("#9c9ca4",K).replace("#9c9ca8",K)
open(P,"w",encoding="utf-8").write(h)
print("PDF-exact(300dpi,p3): red",R,"green",G,"blue",B,"grey",K)
