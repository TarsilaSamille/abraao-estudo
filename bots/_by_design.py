...
# 4 regioes verticais (4 designs empilhados)
bands=[("D1",0,600),("D2",600,1200),("D3",1200,1800),("D4",1800,2400)]
# se D1 vazio (y0-600 deu {}), usar a area cinza do macro: tente 2400-3000
def topcols(y0,y1):
    c=Counter()
    ...
    return [( '#%02x%02x%02x'%k,n) for k,n in c.most_common(8)]
for name,y0,y1 in bands:
    print(name, topcols(y0,y1))
