...
R,G,B,K="#ae5266","#4c7c60","#4876ae","#9c9ca4"
# 1) hex velhos -> exatos
for old,new in [("#a85a43",R),("#3c6049",G),("#34588b",B),("#787878",K),
               ("#af5267",R),("#487860",G),("#4877ae",B),("#9d9ea7",K)]:
    for pre in ("border-[","bg-[","text-["):
        h=h.replace(pre+old+"]",pre+new+"]")
# 2) Tailwind -> exatos
for a,b in [
...
print("applied red",R,"green",G,"blue",B,"grey",K)
